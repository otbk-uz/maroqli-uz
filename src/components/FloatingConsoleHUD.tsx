        ...
        <div className="flex items-center space-x-3">
          ...
          {isAuthenticated && user ? (
            <div className="flex items-center space-x-2">
              ...
              {/* Profile Avatar */}
              <Link href="/profile" className="w-7 h-7 rounded-full bg-primary/20 text-primary flex items-center justify-center font-bold text-xs border border-white/5 flex-shrink-0">
